...
+ (BOOL)contain:(NSString *)targetStr inText:(NSString *)text{
    return [self getCountTargetString:targetStr inText:text]>0;
}
...
+ (BOOL)isBetweenLeftString:(NSString *)leftString RightString:(NSString *)rightString targetStringRange:(NSRange)range inText:(NSString *)text{
    ...
    if ([text rangeOfString:targetString].location!=NSNotFound) {
        ...
        NSInteger leftStringAtLeftIndex,rightStringAtLeftIndex,rightStringAtRightIndex,leftStringAtRightIndex;
...
+ (NSString *)removeFirstStr:(NSString *)str withText:(NSString *)text{
...
+ (BOOL)matches:(NSString *)regex text:(NSString *)text{
