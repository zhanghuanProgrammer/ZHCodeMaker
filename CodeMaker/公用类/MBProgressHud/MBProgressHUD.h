...
+ (void)showHUDAddedToView:(UIView *)view withText:(NSString *)text withDuration:(CGFloat)duration animated:(BOOL)animated;
+ (instancetype)showHUDAddedToView:(UIView *)view animated:(BOOL)animated;

/// @name Showing and hiding

/**
 * Finds the top-most HUD subview and hides it. The counterpart to this method is showHUDAddedToView:animated:.
 *
 ...
 *
 * @see showHUDAddedToView:animated:
 * @see animationType
 */
