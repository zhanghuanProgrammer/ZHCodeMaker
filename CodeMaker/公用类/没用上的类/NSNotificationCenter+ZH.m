#import "NSNotificationCenter+ZH.h"
#include <pthread.h>

@implementation NSNotificationCenter (ZH)
- (void)postNotificationOnMainThread:(NSNotification *)notification {
    if (pthread_main_np()) return [self postNotification:notification];//如果在主线程中,直接发起通知
    [self postNotificationOnMainThread:notification waitUntilDone:NO];//否则,等这条线程运行完再发
}
