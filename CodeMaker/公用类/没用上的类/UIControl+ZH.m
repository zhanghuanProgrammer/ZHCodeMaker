...
- (void)setTarget:(id)target action:(SEL)action forControlEvents:(UIControlEvents)controlEvents {//受教了
...
- (void)removeAllBlocksForControlEvents:(UIControlEvents)controlEvents {
    ...
    for (_UIControlBlockTarget *target in targets) {
        if (target.events & controlEvents) {
            UIControlEvents newEvent = target.events & (~controlEvents);//受教了
            if (newEvent) {//受教了
