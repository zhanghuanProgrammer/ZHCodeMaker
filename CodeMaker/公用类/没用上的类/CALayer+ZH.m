...
UIViewContentMode CAGravityToUIViewContentMode(NSString *gravity) {
...
- (UIViewContentMode)contentMode {
    return CAGravityToUIViewContentMode(self.contentsGravity);
}

NSString *UIViewContentModeToCAGravity(UIViewContentMode contentMode) {
    switch (contentMode) {
...
- (void)setContentMode:(UIViewContentMode)contentMode {
    self.contentsGravity = UIViewContentModeToCAGravity(contentMode);
}
