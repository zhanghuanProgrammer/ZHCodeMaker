#import "ZHFrameProjectViewController.h"
#import "ZHStroyBoardToFrameProject.h"

@interface ZHFrameProjectViewController ()
...
@implementation ZHFrameProjectViewController
...
- (void)OkAction{
    ...
    dispatch_async(dispatch_get_global_queue(0, 0), ^{
        ...
        // 处理耗时操作的代码块...
        [[ZHStroyBoardToFrameProject new] transformProjectToFrameProject:self.path];
