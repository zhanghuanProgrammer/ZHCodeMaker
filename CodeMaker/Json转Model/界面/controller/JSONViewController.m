...
- (void)succeesNSNULL:(BOOL)NSNULL NSNUMBER:(BOOL)NSNUMBER NSDATE:(BOOL)NSDATE guidang:(BOOL)guidang{
    if(_dict!=nil){
        ...
        [CreatJaveModel creatProperty:_dict fileName:self.modelName.text WithContext:@"" savePath:self.savaPath withNSNULL:NSNULL withNSDATE:NSDATE withNSNUMBER:NSNUMBER withModelName:self.modelName.text withFatherClass:@""];
        ...
        [CreatJaveModel creatProperty:_arr fileName:self.modelName.text WithContext:@"" savePath:self.savaPath withNSNULL:NSNULL withNSDATE:NSDATE withNSNUMBER:NSNUMBER withModelName:self.modelName.text withFatherClass:@""];
        [CreatPropert saveTextWithModelName:self.modelName.text savePath:self.savaPath];
        [MBProgressHUD showHUDAddedToView:self.view withText:@"生成成功,请打开文件夹" withDuration:1 animated:NO];
        [self JsonToPlistWithFilePath:self.filePath];
    }
